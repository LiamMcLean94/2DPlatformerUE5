...
void AFallingInteraction::BeginPlay()
{
	...
	BoxComponent->OnComponentBeginOverlap.AddDynamic(this,&AFallingInteraction::BoxBeginOverlapped);
}

void AFallingInteraction::BoxBeginOverlapped(UPrimitiveComponent* OverlappedComp, AActor* OtherActor,
...
void AFallingInteraction::OnFall()
{
	if (ProjectileMovementComponent)
	{
		...
		GetWorld()->GetTimerManager().SetTimer(TimerHandle, this, &AFallingInteraction::OnReset, RespawnpDelay, false);
	}
}
