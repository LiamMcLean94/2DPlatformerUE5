...
void ALadderInteraction::BeginPlay()
{
	...
	BoxComponent->OnComponentBeginOverlap.AddDynamic(this, &ALadderInteraction::BoxBeginOverlapped);
	BoxComponent->OnComponentEndOverlap.AddDynamic(this, &ALadderInteraction::BoxEndOverlapped);
	...
	if (PlayerController)
	{
		...
		PlayerCharacter = Cast<APlatformer2DCharacter>(CurrentCharacter);
	}
...
void ALadderInteraction::BoxBeginOverlapped(UPrimitiveComponent* OverlappedComp, AActor* OtherActor,
...
void ALadderInteraction::BoxEndOverlapped(UPrimitiveComponent* OverlappedComp, AActor* OtherActor,
